...
export default function Profile() {
  ...
  return (
    <>
      <Container className="mt-5 pt-5 w-50  mb-5 ">
        <div
          className="rounded"
          style={{ padding: "1px", backgroundColor: "#1F1F1F" }}
        >
          <div className="d-flex">
            <div>
              <h4 className="text-white fw-bold mt-5 ms-5 mb-4">
                Personal Info
              </h4>
              <div className="ps-5 d-flex align-items-center">
                ...
                <div>
                  <p className="text-light fw-semibold ps-3">
                    {state.user.fullname} <br></br>{" "}
                    <p className="fw-light" style={{ color: "#8A8C90" }}>
                      Fullname
                    </p>
                  </p>
                </div>
